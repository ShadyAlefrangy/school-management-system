...
<table id="customers">
  <tr>
    ...
    <td>
        ...
        <p><b style="color: #04AA6D">Student Exam Type Fee</b></p>
    </td>
  </tr>
</table>
@php
    $examfee = App\Models\FeeCategoryAmount::where('fee_category_id','3')->where('class_id',$student->class_id)->first();
...
<table id="customers">
    <tr>
      ...
      <th width="45%">Student Data</th>
        ...
        <tr>
            <td>9</td>
            <td>Fee for This  {{ $exam_type }} Exam</td>
            <td>{{ $finalfee }} $</td>
        </tr>
</table>
<br><br>
