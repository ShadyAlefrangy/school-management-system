...
class MonthlyFeeController extends Controller
{
    public function monthlyFeeView()
    {
        ...
        return view('backend.student.monthly-fee.monthly-fee-view', $data);
    }
   ...
   public function monthlyFeePayslip(Request $request)
   {
        ...
        $data['student'] = AssignStudent::with(['student', 'discount'])->where('student_id', $student_id)->where('class_id', $class_id)->first();
        $pdf = PDF::loadView('backend.student.monthly-fee.monthly-fee-details', $data);
