...
class RegistrationFeeController extends Controller
{
    public function registrationFeeView()
    {
        ...
        return view('backend.student.registration-fee.registration-fee-view', $data);
    }
   ...
   public function registrationFeePayslip(Request $request)
   {
       ...
       $allStudent['student'] = AssignStudent::with(['student', 'discount'])->where('student_id', $student_id)->where('class_id', $class_id)->first();
        $pdf = PDF::loadView('backend.student.registration-fee.registration-fee-details', $allStudent);
